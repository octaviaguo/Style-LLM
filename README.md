...
## Data
### Style Data
The benchmark data can be found under `data`. Each style dataset is splitted to train, validation and test sets. Examples of novel styles generated by LLMs (as described in Section 4 of the paper) can be found at `data/llm_generated_styles`. 

### Style Lexicon
Lexicons collected from various sources for all styles in this benchmark can be found under `lexicon`.
